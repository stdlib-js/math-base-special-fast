...
```javascript
import fmath from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-fast@v0.4.1-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { abs, absf, acosh, ampbm, asinh, atanh, hypot, log2Uint32, max, min, powint, sqrtUint32 } from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-fast@v0.4.1-deno/mod.js';
```
...
[@stdlib/math/base/special/fast/absf]: https://github.com/stdlib-js/math-base-special-fast-absf/tree/deno
